      ...
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-center">
        <div className="bg-white mx-auto w-full h-auto px-2 flex flex-col gap-4 items-center py-4 justify-center rounded-md">
          ...
          >
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4">
                  ...
                  >
                    ...
                    <option value="Meezan Bank">BOB</option>
                    <option value="UBL">SBI</option>
                    <option value="HBL">PNB</option>
                    <option value="Allied Bank">ICICI</option>
                  </select>
                  <input
                    type="text"
                    value={bankAccountNumber}
                    placeholder="123546789"
            ...
            <button
              className="bg-[#3bb19b] w-[420px] font-semibold hover:bg-[#b8381e] transition-all duration-300 text-xl py-2 px-4 rounded-md text-white mx-auto lg:w-[640px] my-4"
              type="submit"
              disabled={loading}
            >
              {loading && "Registering..."}
