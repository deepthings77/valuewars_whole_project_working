          ...
          >
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                className="w-full mt-1 p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#3bb19b]"
                required
              />
            </div>
            <div className="flex flex-col gap-2">
            ...
            <button
              className="bg-[#3bb19b] mx-auto font-semibold hover:bg-[#b8381e] text-xl transition-all duration-300 py-2 px-4 rounded-md text-white my-4"
              type="submit"
            >
