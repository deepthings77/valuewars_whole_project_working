      ...
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] gap-7 flex flex-col min-h-screen py-4 justify-center">
        <div>
          ...
          <p className="text-xl text-stone-600">
            Welcome to Valuewars, the ultimate destination for online auctions
            and bidding excitement. We are dedicated to
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            At Valuewars, our mission is to revolutionize the way people buy and
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            Whether you're looking to buy, sell, or simply explore, Valuewars
            invites you to join our growing community of auction enthusiasts.
           
          </p>
        </div>
        <div>
          <p className="text-[#3bb19b] text-xl font-bold mb-3">
            Thank you for choosing Valuewars.
          </p>
        </div>
      </section>
    </>
